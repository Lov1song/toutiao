...
class News(Base):
    ...
    description : Mapped[str] = mapped_column(String(500),nullable=True,comment="新闻描述")
    content : Mapped[str] = mapped_column(Text,nullable=False,comment="新闻内容")
    image: Mapped[Optional[str]] = mapped_column(String,comment="新闻图片URL")
    author : Mapped[Optional[str]] = mapped_column(String,nullable=False,comment="新闻作者")
